...
abstract contract DataPrivacyFramework is Ownable {
    ...
    modifier onlyAllowedUserOperation(string memory operation) {
     ...
     * @return _ boolean indicating if the update succeeded
     */
    function addAllowedOperation(string memory operation) public onlyOwner returns (bool) {
     ...
     * @return _ boolean indicating if the update succeeded
     */
    function addRestrictedOperation(string memory operation) public onlyOwner returns (bool) {
